...
const subcategoryData = [
    {
        serviceTitle: "Housekeeper", // Main Service Title to find
        sub: {
            name: "Housekeeper",
    ...
    {
        serviceTitle: "Elderly Care", // Might need fuzzy match or "24 Hrs - Elderly Care"
        sub: {
            name: "Elderly Care",
...
const seed = async () => {
    ...
    for (const item of subcategoryData) {
        ...
        if (service) {
            ...
            // Use existing image for subcategory if available
            ...
            const newSub = {
                ...
                image: imageUrl // Reusing main image as "subcategory image"
            };

            // Update service
            service.subcategories = [newSub]; // Overwrite or PUSH? User implies this IS the data. Overwrite for clarity.
            await service.save();
