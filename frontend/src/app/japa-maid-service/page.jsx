...
export const metadata = {
    title: "24 Hrs Japa Maid Service - Safely Hands",
    description: "Hire professional full-time japa maids for your home. Verified and trained by Safely Hands.",
};

export default async function JapaMaidServicePage() {
    const slug = "japa-maid-service";
